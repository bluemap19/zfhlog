...
if __name__ == '__main__':
    ...
    COL_NAMES = [
        ...
        # 'DYNA_DIS', 'STAT_ENG',
        'DYNA_COR', 'DYNA_XY_COR', 'DYNA_XY_DIS', 'DYNA_XY_HOM', 'DYNA_XY_CON', 'DYNA_DIS',
        'STAT_COR', 'DYNA_CON', 'DYNA_XY_ENT', 'DYNA_ASM', 'STAT_XY_ASM', 'STAT_XY_DIS',
    ...
    print(type(pca_result), pca_result)
